...
const VideoArea = () => {
    ...
    return (
        <>
            <div className="tp-support-area tp-support-area-2  p-relative" style={{backgroundImage: `url(/assets/img/onemobility-assets/pic-bg.jpg)`}}>
