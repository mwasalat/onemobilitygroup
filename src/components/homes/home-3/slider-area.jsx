...
const slider_data = [
    {
        id: 1,
        bg_img: "/assets/img/onemobility-assets/banner-1920-x-828.png",
        bg_title: "MOBILITY",
        subtitle: "Driving the future of urban mobility",
        title: "One Mobility Group — Smarter Cities Worldwide",
    },

    {
        id: 2,
        bg_img: "/assets/img/onemobility-assets/banner-1920-x-853-px.png",
        bg_title: "TRANSIT",
        subtitle: "Reliable & sustainable transportation",
