...
const about_content = {
    ...
    subtitle: "About Us",
    title: "Driving The Future Of Urban Mobility",
    description: <>One Mobility Group enhances mass transit approachability, efficiency, and convenience for smarter cities worldwide with reliable and sustainable solutions.</>,

    title_1: "Premier Transportation Services",
    title_2: "Technology & Innovation",
    des_1: "Auto rental, taxi, public & school transport across multiple regions.",
    des_2: "IoT, AI, predictive maintenance & blockchain-powered fleet solutions.",
